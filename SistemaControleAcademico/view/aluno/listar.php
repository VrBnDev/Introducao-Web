...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
		  ...
		  <button type="button" class="btn btn-primary" onclick="location.href='../controller/alunoController.php?funcao=cadastroAluno'"><i class="fa-solid fa-plus"></i> Cadastrar Aluno</button>
